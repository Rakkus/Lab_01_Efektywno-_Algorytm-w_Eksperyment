    ...
    class Program
    {
        public class Timer
        {
            ...
            public void getAttempt(int type, int size, int minVal = 0, int maxVal = 0, int almost = 0)
            {
                ...
                {
                    case 1:
                        A_T = generator.GenerateRandom(size, minVal, maxVal);
                        break;
                    case 2:
                        A_T = generator.GenerateSorted(size, minVal, maxVal);
                        break;
                    case 3:
                        A_T = generator.GenerateReversed(size, minVal, maxVal);
                        break;
                    case 4:
                        A_T = generator.GenerateAlmost(size, minVal, maxVal, almost);
                        break;
                    case 5:
                        A_T = generator.GenerateFewUnique(size);
                        break;
                }
